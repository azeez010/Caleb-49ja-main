...
class BootBot:
  def __init__(self, driver: Chrome, data: DataManager, boot_type: BootType):
    ...
    if boot_type == BootType.Real:
      ...
      self.driver.get("https://logigames.bet9ja.com/Games/Launcher?gameId=11000&provider=0&pff=1&skin=201")
...
class Authentication():
  ...
  def click_on_live_games(self):
    game = self.driver.find_element(By.CSS_SELECTOR, "#\\31 1000 .game__info > .btn-primary-xxs")
  ...
  def switch_to_live_games(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".col-2:nth-child(3) > .red > .rainbow__ball-value").click()
  ...
  def login_with_cookie(self, cookies):
    self.driver.get("https://logigames.bet9ja.com/Games/Launcher?gameId=11000&provider=0&pff=0&skin=201")
